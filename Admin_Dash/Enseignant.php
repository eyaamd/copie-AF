                  ...
                  if ($result->num_rows > 0) {
                    ...
                    while ($row = $result->fetch_assoc()) {
                      ...
                      <tr class='text-gray-700 dark:text-gray-400'>
                        ...
                        <td class='px-4 py-3 text-xs'>
                          <a href="Modifier_ens.php?updateid=<?php echo $row['id']; ?>" role="button"
                          ...
                          <a href="Supprimer_ens.php?deleteid=<?php echo $row['id']; ?>" role="button"
                            onclick="alert('Suppression doit être faite à partir de la base de données'); return false;"
